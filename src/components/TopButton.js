...
const TopButton = forwardRef((props, ref) => {
  ...
  return (
    <div className='sticky w-full h-20 md:h-40 bottom-4 z-20 flex justify-center'>
        <div className="w-10 h-10 md:w-16 md:h-16 rounded-full hover:animate-bounce hover:cursor-pointer" onClick={() => handleClick(ref)}>
